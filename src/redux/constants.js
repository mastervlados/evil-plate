...
export const ON_PERFORMANCE_SET_DELETED='on-performance-set-deleted'
export const ON_PERFORMANCE_ROW_CHECKBOX_CHANGED='on-performance-row-checkbox-changed'
export const ON_PERFORMANCE_ROW_WEIGHT_CHANGED='on-performance-row-weight-changed'
export const ON_PERFORMANCE_ROW_REPS_CHANGED='on-performance-row-reps-changed'