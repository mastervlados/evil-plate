export default class DummyAppService {
    ...
    exercises = [
        ...
        { id: 2, title: '2 Exercise with dumbbells for example', type: 'stereo', colorNumber: 5 },
        { id: 3, title: 'Exercise with self body weight', type: 'self', colorNumber: 5 },
        { id: 4, title: 'Exercise with a barbell for example', type: 'mono', colorNumber: 5 },
        { id: 5, title: 'Exercise with dumbbells for example', type: 'stereo', colorNumber: 5 },
        { id: 6, title: 'Exercise with self body weight', type: 'self', colorNumber: 5 },
        { id: 7, title: 'Exercise with a barbell for example', type: 'mono', colorNumber: 5 },
        { id: 8, title: 'Exercise with dumbbells for example', type: 'stereo', colorNumber: 5 },
        { id: 9, title: 'Exercise with self body weight', type: 'self', colorNumber: 5 },
        { id: 10, title: 'Exercise with a barbell for example', type: 'mono', colorNumber: 5 },
        { id: 11, title: 'Exercise with dumbbells for example', type: 'stereo', colorNumber: 5 },
        { id: 12, title: 'Exercise with self body weight', type: 'self', colorNumber: 5 },
